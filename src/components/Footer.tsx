...
export default function Footer() {
  ...
  return (
    <footer className="mt-16 bg-black border-t border-neutral-900 text-neutral-300 py-12 transition-colors relative">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 text-xs font-mono text-neutral-400 font-medium">
